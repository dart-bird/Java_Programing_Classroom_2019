public class LetterGradeCourse extends Course {
	...
	public String getGrade() {
		...
		else if(getTotal() >= 80 && getTotal() < 90) return "B";
		else if(getTotal() >= 70 && getTotal() < 80) return "C";
		else if(getTotal() >= 60 && getTotal() < 70) return "D";
		else return "F";
	}
	...
	public String toString(){
		// 여기에 코드를 입력하세요
		return ("교과목 이름: " +courseName+ ", 출석점수: " +attendScore+ ", 과제 점수: " +assignScore+ ", 시험 점수:" +examScore);
	}
